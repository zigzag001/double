...
API_KEY = os.environ.get("AI_API_KEY") or "sk-vtZ2I1JrbaVqIlgTihcglVTnvdPRJYAs"
if not API_KEY:
...
MODELS = [
    ...
    {"id": "sensenova-6.7-flash-lite", "name": "sensenova-6.7-flash-lite", "model_id": "team_alpha_arena_v1"},
    {"id": "sensenova-6.7-flash-lite", "name": "sensenova-6.7-flash-lite", "model_id": "Gemini2.5"},
    {"id": "sensenova-6.7-flash-lite", "name": "sensenova-6.7-flash-lite", "model_id": "DeepseekR1"},
]
